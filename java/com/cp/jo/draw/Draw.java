...
public class Draw extends View {
    ...
    public void InitializePaints() {
        ...
        mTextPaint.setShadowLayer(4, 2, 4, Color.argb(100, 0, 0, 0));

        mTextInfo = new Paint();
        mTextInfo.setStyle(Paint.Style.FILL_AND_STROKE);
        mTextInfo.setAntiAlias(true);
        mTextInfo.setColor(Color.rgb(0, 0, 0));
        mTextInfo.setTextAlign(Paint.Align.LEFT);
        mTextInfo.setStrokeWidth(1);
        mTextInfo.setShadowLayer(4, 2, 4, Color.argb(100, 0, 0, 0));


    }

    public void ClearCanvas(Canvas cvs) {cvs.drawColor(Color.TRANSPARENT, PorterDuff.Mode.CLEAR);}
