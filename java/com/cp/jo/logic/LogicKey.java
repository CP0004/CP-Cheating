...
public class LogicKey {
    ...
    public MutableLiveData<CallbackKey> getDateKey(String key, String nameDevice) {
        ...
        FirebaseFirestore.getInstance().collection(LocalData.COLLECTION_KEY).whereEqualTo(LocalData.KEY_KEY, key.trim()).get()
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful() && !task.getResult().isEmpty()) {
                        ...
                        long dateExpiration = data.getDouble(LocalData.KEY_DATE_EXPIRATION).longValue();
                        ...
                        if (dateUse > 0 &&  //-- RESET KEY
                            ...
                            requestData.put(LocalData.KEY_NAME_DEVICE, nameDevice);
                            ...
                            if (data.getBoolean(LocalData.KEY_IS_PREMIUM) && !data.getString(LocalData.KEY_USER_UID).equals(userUid) && !data.getString(LocalData.KEY_NAME_DEVICE).equals(nameDevice)) {
