...
public class PropertiesActivity {
    ...
    //-- Button Stop
    public static void buttonStop(ActivityMainBinding binding) {
        binding.MainRootHome.HomeBtnInjectionGl.setVisibility(View.VISIBLE);
        binding.MainRootHome.HomeBtnInjectionKr.setVisibility(View.VISIBLE);
        binding.MainRootHome.HomeBtnInjectionVn.setVisibility(View.VISIBLE);
        binding.MainRootHome.HomeBtnInjectionTw.setVisibility(View.VISIBLE);
        binding.MainRootHome.HomeBtnInjectionStop.setVisibility(View.GONE);
    }

    //-- Button Start
    public static void buttonStart(ActivityMainBinding binding) {
        binding.MainRootHome.HomeBtnInjectionGl.setVisibility(View.GONE);
        binding.MainRootHome.HomeBtnInjectionKr.setVisibility(View.GONE);
        binding.MainRootHome.HomeBtnInjectionVn.setVisibility(View.GONE);
        binding.MainRootHome.HomeBtnInjectionTw.setVisibility(View.GONE);
        binding.MainRootHome.HomeBtnInjectionStop.setVisibility(View.VISIBLE);
    }
