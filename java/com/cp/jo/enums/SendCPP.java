...
public enum SendCPP {
    ...
    LESS, CROSS, AIMBOT_SDK, IPAD_VIEW, IS_AIMBOT, IS_BOT_AIMBOT, IS_KNOCK_AIMBOT, FOV_AIMBOT, DIST_AIMBOT, PRIORITY_AIMBOT, TARGET_AIMBOT, OFFSET_SCOPE, OFFSET_NO_SCOPE, //-- CONTROLS
