...
public class MainService extends Service {
    ...
    public void onCreate() {
        ...
        Tools.OnChecked(this, binding.FloatRootMemory.MemoryCbBullet, false, SendCPP.IS_BULLET.ordinal(), -1, Tools.checkPremium());
        ...
        //Fake
        Tools.OnChecked(this, binding.FloatRootMemory.MemoryCbInstantHit, false, -1, -1, Tools.checkPremium());
        Tools.OnChecked(this, binding.FloatRootMemory.MemoryCbSmartDamage, false, -1, -1, Tools.checkPremium());
        Tools.OnChecked(this, binding.FloatRootMemory.MemoryCbHead20, false, -1, -1, Tools.checkPremium());
        //-- Setting
    ...
    void CreateOverly(ContextThemeWrapper context) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O)
            params = new WindowManager.LayoutParams(WindowManager.LayoutParams.WRAP_CONTENT, WindowManager.LayoutParams.WRAP_CONTENT, WindowManager.LayoutParams.TYPE_APPLICATION_OVERLAY, WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE | WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE, PixelFormat.TRANSLUCENT);
        else
            params = new WindowManager.LayoutParams(WindowManager.LayoutParams.WRAP_CONTENT, WindowManager.LayoutParams.WRAP_CONTENT, WindowManager.LayoutParams.TYPE_PHONE, WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE | WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE, PixelFormat.TRANSLUCENT);
